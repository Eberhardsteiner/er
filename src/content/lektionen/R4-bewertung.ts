...
export const lektionR4: Lektion = {
  ...
  quiz: [
    ...
    },
    {
      ...
      antworten: ['Voll', 'Zur Hälfte', 'Nur bei Anlagevermögen', 'Gar nicht, es zählt der Nettobetrag', 'Wahlweise'],
      richtig: 3,
      erklaerung:
    ...
    },
    {
      ...
      teilaufgaben: [
        ...
        },
        {
          ...
          optionen: ['Das lineare', 'Das degressive', 'Das leistungsabhängige', 'Das progressive'],
          richtig: 0,
          punkte: 5,
        },
        {
